...
@RestController
@RequestMapping(Array("/comment"))
class CommentController(@Autowired override val typeCountService: TypeCountService)
  extends BaseController(typeCountService, Entity.COMMENT) {
